...
/**
 * <p>Java class for CardReaderTypeValues.
 * 
 ...
 * 
 */
@XmlType(name = "CardReaderTypeValues")
@XmlEnum
public enum CardReaderTypeValues {
    ...
    public static CardReaderTypeValues fromValue(String v) {
        for (CardReaderTypeValues c: CardReaderTypeValues.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
