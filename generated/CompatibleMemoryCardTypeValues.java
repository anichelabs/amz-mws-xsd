...
/**
 * <p>Java class for CompatibleMemoryCardTypeValues.
 * 
...
public enum CompatibleMemoryCardTypeValues {
    ...
    CompatibleMemoryCardTypeValues(String v) {
        value = v;
    }
    ...
    public static CompatibleMemoryCardTypeValues fromValue(String v) {
        for (CompatibleMemoryCardTypeValues c: CompatibleMemoryCardTypeValues.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
